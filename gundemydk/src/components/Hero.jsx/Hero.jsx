...
const Hero = () => {
  return (
    <main className="bg-gradient-to-r from-violet-950 to-violet-900 pt-20 dark:bg-violet-950">
      <section className="container flex min-h-[550px] flex-col items-center justify-center md:min-h-[500px] ">
        <div className="grid grid-cols-1 items-center gap-8 dark:text-white md:grid-cols-2">
          ...
          >
            <h1 className=" text-4xl ">
              Güvenilir ve Profesyonel Yapı Denetim Hizmeti
            </h1>
            <p className="">
              Gündem Yapı Denetim olarak, 4708 sayılı Yapı Denetimi Hakkında Kanun kapsamında,
              yapılarınızın güvenliği ve kalitesi için uzman kadromuzla hizmetinizdeyiz.
            </p>
